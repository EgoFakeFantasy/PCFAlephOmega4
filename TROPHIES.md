...
| PCF-104 | `exists_omegaOneClubGuessingAtAlephThree` | 在 `omega_3` 以下构造同时猜测无界闭子集的 `omega_1` 梯系统 | 结论在项目基础理论中直接证明，不把猜测系统作为假设 | [LocalRank.lean](PcfProject/LocalRank.lean#L1225) |
